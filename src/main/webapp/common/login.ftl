...
<@head title="登录">
    ...
    <link rel="stylesheet" href="${staticServePath}/assets/font-awesome/4.2.0/css/font-awesome.min.css"/>

    <!-- text fonts -->
    <link rel="stylesheet" href="${staticServePath}/assets/fonts/fonts.googleapis.com.css"/>

    <!-- ace styles -->
    <link rel="stylesheet" href="${staticServePath}/assets/css/ace.min.css"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${staticServePath}/assets/css/ace-part2.min.css"/>
    <![endif]-->
    <link rel="stylesheet" href="${staticServePath}/assets/css/ace-rtl.min.css"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${staticServePath}/assets/css/ace-ie.min.css"/>
    <![endif]-->

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

    <!--[if lt IE 9]>
    <script src="${staticServePath}/assets/js/html5shiv.min.js"></script>
    <script src="${staticServePath}/assets/js/respond.min.js"></script>
    <![endif]-->
</@head>
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">互动无限</span>
                            <span class="white" id="id-text2">用户中心</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; 互动无限科技有限公司</h4>
                    </div>
